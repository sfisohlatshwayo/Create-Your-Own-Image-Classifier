...
def parse_args():
    ...
    parser.add_argument('checkpoint', action='store', default='checkpoints/checkpoint.pth') #mentor suggested
    parser.add_argument('--top_k', dest='top_k', default='3')
    parser.add_argument('--filepath', dest='filepath', default='flowers/test/28/image_05230.jpg') # use a deafault filepath to a stemless
