...
def parse_args():
    ...
    parser.add_argument('--save_dir', dest="save_dir", action="store", default="checkpoints/checkpoint.pth")#Mentor suggested
    return parser.parse_args()

def train_model(model, criterion, optimizer, dataloaders, epochs, gpu):
    steps = 0
    print_every = 10
...
def main():
    ...
    gpu = args.gpu 
    train_model(model, criterion, optimizer, dataloaders, epochs, gpu)
